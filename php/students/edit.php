    ...
    <div class="detail_table">
        <form action="submit_edit.php" method="post">
            <table>
                <tr>
                    <td>First</td>
                    <td><input class="textbox" name="student[first]" type="text" value="<?=$student['Student First Name']?>"></td>
                </tr>
                <tr>
                    <td>Middle</td>
                ...
                <tr>
                    <td>Last</td>
                    <td><input class="textbox" name="student[last]" type="text" value="<?=$student['Student Last Name']?>"></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>SSID</td>
                    <td><input class="textbox" name="student[ssid]" type="text" value="<?=$student['SID']?>"></td>
                </tr>
                    <td>Cohort/Year</td>
                    <td><input class="textbox" name="student[cohort]" type="text" value="<?=$student['Cohort']?>"></td>
                </tr>
                <tr>
