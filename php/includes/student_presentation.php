...
detailFieldIsVisible($field)
createStudentDetailTableRows($student)
GetOptionSelectedStatus($optionIndex, $selectedIndex)
CreateOptionsFrom($statuses, $selectedIndex)
createStudentNotesTableRows($notes)
*/
